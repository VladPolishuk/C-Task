...
void addMuseum(string fileInput, Museum museum)
{
    ...
    ifstream inputFile("C:\\Users\\Vlad\\Desktop\\Task4\\Debug\\" + fileInput + ".txt");
    int maxID = 0;
    string line;
    ...
    cout << "Введите название экспоната: ";
    getline(cin, museum.name);
    cout << "Введите описание экспоната: ";
    cin >> museum.description;
    cout << "Введите зала где находится экспонат: ";
    cin >> museum.hall;

    ofstream outputFile("C:\\Users\\Vlad\\Desktop\\Task4\\x64\\Debug\\" + fileInput + ".txt", ios::app);
...
void listMuseum(string fileInput, Museum museum)
{
    ...
    ifstream inputFile("C:\\Users\\Vlad\\Desktop\\Task4\\x64\\Debug\\" + fileInput + ".txt");
...
void deleteMuseum(string fileInput, Museum museum) {
    ...
    ofstream tempFile("C:\\Users\\Vlad\\Desktop\\Task4\\x64\\Debug\\temp.txt");
    ...
    while (getline(inputFile, line)) {
        ...
        if (id == museumIDToDelete) {
            museumFound = true;
            cout << "Экспонат с ID " << museumIDToDelete << " удален." << endl;
        }
        else {
    ...
    if (!museumFound) {
        cout << "Экспонат с ID " << museumIDToDelete << " не найден." << endl;
    }
    else {
        ofstream outputFile("C:\\Users\\Vlad\\Desktop\\Task4\\x64\\Debug\\" + fileInput + ".txt");
        ifstream tempFile("C:\\Users\\Vlad\\Desktop\\Task4\\x64\\Debug\\temp.txt");
